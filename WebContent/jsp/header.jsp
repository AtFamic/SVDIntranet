...
<nav>
	...
	<li><a href="/SVD_IntraNet/WeeklyViewServlet">スケジュール</a></li>
	...
	<li><a href="/SVD_IntraNet/AccountInfoServlet">アカウント情報</a></li>
	<li><a href="/SVD_IntraNet/LogoutServlet">ログアウト</a></li>
      </ul>
</nav>
